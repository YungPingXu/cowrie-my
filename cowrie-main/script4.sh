...
sudo qemu-system-x86_64 -name qvm0 -smbios type=0,uefi=on -enable-kvm -smp 2 -m 4096 -hda /home/speedlab-ml-3/qvm0.qcow2 -boot c -netdev bridge,br=br0,id=net0 -device e1000,netdev=net0,mac=52:54:00:12:43:00 -vnc 0.0.0.0:0
